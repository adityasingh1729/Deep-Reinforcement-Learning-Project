...
class Convnet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 6, 5) # input channel = 3 for the 3 colours, output channel = 6, kernel size = 5 => 5x5 
        self.pool = nn.MaxPool2d(2,2)
        self.conv2 = nn.Conv2d(6,16,5) # new input channel = last output channel size
        self.fc1 = nn.Linear(16*5*5, 120) # specifies the fully connected layer
